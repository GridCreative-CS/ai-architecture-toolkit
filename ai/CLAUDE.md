...
- `templates/design-system-template.md` section numbers are cited by `prompts/design-system-generator.md` (§2f, §8), `prompts/design-system-from-inventory.md` (§2f), `prompts/design-system-completeness-gate.md` (§2–§7 by check), `prompts/ui-compliance-check.md` (§6), and `templates/feature-spec-template.md` (§6) — §§1–8 must never be renumbered; new sections are appended (§2f, §9)
- `prompts/design-system-completeness-gate.md` defines **six** checks (C1–C6) and the verdict vocabulary `APPROVED` / `APPROVED WITH NOTES` / `REJECTED — MUST FIX`; the gate is cited by `workflows/ui-foundation-workflow.md` Step 1b, `workflows/ui-retrofit-workflow.md` Step 2b, `workflows/engineering-workflow.md` Step 0b and missing-input handling, both design system generators, `guides/glossary.md`, `guides/operating-model.md`, `guides/quick-start.md`, `guides/toolkit-map.md`, root `CLAUDE.md` rule 12, and `.github/copilot-instructions.md` rule 12 — changing the check count or verdict vocabulary requires updating all of them
