...
feature spec and `ai-parts/OVERVIEW.md` plus the specific `ai-parts/PXX-*.md` Part.
The delivery plan is the roadmap; the Part files are the execution-ready handoff.
