---
name: "Backend Agent"
description: "Implement backend slices in .NET using contract-first TDD, respecting module boundaries and approved architecture."
tools: [
  read/readFile,
  read/problems,
...
Apply the baseline from `expert-dotnet-software-engineer.agent.md`, plus the backend-specific instructions below.
